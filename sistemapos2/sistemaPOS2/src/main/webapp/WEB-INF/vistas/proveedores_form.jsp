...
<form:form modelAttribute="proveedor" role="form" enctype="multipart/form-data" action="${pageContext.servletContext.contextPath}/proveedores/${accion}">
	<fieldset>
...
<div class="col-sm-2">	
	<img alt="" class="img-responsive" src="<c:url value='/imagenes?imagen=${proveedor.imagen}'/>">
</div>	
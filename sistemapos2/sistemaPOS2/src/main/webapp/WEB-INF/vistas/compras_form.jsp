...
<script type="text/javascript"> $('#titulo').text('Compras');   </script>		
...
<form:form id="agregarForm" modelAttribute="documento" action="${pageContext.servletContext.contextPath}/compras/agregar" role="form" cssClass="form-horizontal" >
	...
	<div class="form-group">
		<form:label path="IDProveedor">Proveedor:</form:label>
		<div class="col-sm-10"><form:select path="IDProveedor">
...
<form:form id="documentoForm" modelAttribute="documento" action="${pageContext.servletContext.contextPath}/compras/documento" class="form-horizontal">
	<fieldset>			
	<div class="form-group">	
